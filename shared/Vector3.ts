...
export interface Vec3 {
  ...
  export type Vector3Type = Vector3 | Vec3;
  ...
  export class Vector3 implements Vec3 {
    ...
    public static add(v1: Vector3Type, v2: Vector3Type | number): Vector3 {
      if (typeof v2 === 'number') return new Vector3(v1.x + v2, v1.y + v2, v1.z + v2);
      return new Vector3(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z);
    }
  
    public static subtract(v1: Vector3Type, v2: Vector3Type | number): Vector3 {
      if (typeof v2 === 'number') return new Vector3(v1.x - v2, v1.y - v2, v1.z - v2);
      return new Vector3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
    }
  
    public static multiply(v1: Vector3Type, v2: Vector3Type | number): Vector3 {
      if (typeof v2 === 'number') return new Vector3(v1.x * v2, v1.y * v2, v1.z * v2);
      return new Vector3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z);
    }
  
    public static divide(v1: Vector3Type, v2: Vector3Type | number): Vector3 {
      if (typeof v2 === 'number') return new Vector3(v1.x / v2, v1.y / v2, v1.z / v2);
      return new Vector3(v1.x / v2.x, v1.y / v2.y, v1.z / v2.z);
    }
  
    public static dotProduct(v1: Vector3Type, v2: Vector3Type): number {
      return v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;
    }
  
    public static crossProduct(v1: Vector3Type, v2: Vector3Type): Vector3 {
     ...
     */
    public distanceSquared(v: Vector3Type): number {
     ...
     */
    public distance(v: Vector3Type): number {
    ...
    public crossProduct(v: Vector3Type): Vector3 {
      return Vector3.crossProduct(this, v);
    }
  
    public dotProduct(v: Vector3Type): number {
      return Vector3.dotProduct(this, v);
    }
  
    public add(v: Vector3Type | number): Vector3 {
      return Vector3.add(this, v);
    }
  
    public subtract(v: Vector3Type): Vector3 {
      return Vector3.subtract(this, v);
    }
  
    public multiply(v: Vector3Type | number): Vector3 {
      return Vector3.multiply(this, v);
    }
  
    public divide(v: Vector3Type | number): Vector3 {
    ...
    public replace(v: Vector3Type): void {
      this.x = v.x;
      this.y = v.y;
      this.z = v.z;
    }
